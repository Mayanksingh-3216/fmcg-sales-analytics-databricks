...
base_path = f's3://sportsbar-db-15-03-2025/{data_source}/*.csv'
print(base_path)
...
base_path = "s3://sportsbar-db-15-03-2025/products/*.csv"
...
df_silver = spark.sql("SELECT * FROM fmcg.bronze.products")
